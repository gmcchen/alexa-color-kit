...
def on_session_started(session_started_request, session):
    ...
    print("**GMC** on_session_started requestId=" + session_started_request['requestId']
...
def on_launch(launch_request, session):
    ...
    print("**GMC** on_launch requestId=" + launch_request['requestId'] +
          ", sessionId=" + session['sessionId'])
...
def on_intent(intent_request, session):
    ...
    print("**GMC** on_intent requestId=" + intent_request['requestId'] +
          ", sessionId=" + session['sessionId'])
...
def on_session_ended(session_ended_request, session):
    ...
    """
    print("**GMC** on_session_ended requestId=" + session_ended_request['requestId'] +
          ", sessionId=" + session['sessionId'])
...
def lambda_handler(event, context):
    ...
    """
    print("**GMC** event.session.application.applicationId=" +
    ...
    if (event['session']['application']['applicationId'] !=
             "amzn1.ask.skill.0b6a15e6-caf1-4af8-bf6c-f6b92e2431a3"):
        raise ValueError("Invalid Application ID")
...
def mymain():
    ...
    if request.method == 'POST':
        ...
        return ("ECHO: (" + request.method +") - got request.method - not sure how to handle this")
